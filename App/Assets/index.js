const allLogo = {
  ...
  store: require('./img/store.png'),
  like: require('./img/like.png'),
  kirim: require('./img/kirim.png'),
  kemas: require('./img/kemas.png'),
  bayar: require('./img/bayar.png'),
  bag: require('./img/bag.png'),
  location: require('./img/location.png'),
  love: require('./img/love.png'),
  store2: require('./img/store2.png'),
  chat: require('./img/chat.png'),
  product: require('./img/product.png'),
  kategori: require('./img/kategori.png'),
  siapkirim: require('./img/siapkirim.png'),
