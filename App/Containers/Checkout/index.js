    ...
    const Address = [
     ...
     return (
      <View style={styles.container}>
        ...
        <Pressable style={{ bottom:toDp(60), left:toDp(50)}} onPress={ () => NavigatorService.navigate('Alamat')}>
            <View style={styles.isiAddress}>
                <Text style={{fontSize:toDp(12), right:toDp(16)}}>{Address[0].nama} {Address[0].telepon}</Text>
                <Text style={{fontSize:toDp(12), right:toDp(16)}}>{Address[0].alamat}</Text>
