        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.ScrollView}>
                ...
                <View style={styles.content}>
                    <TouchableOpacity style={styles.presable} onPress={() => NavigatorService.navigate('Tokobangunan')}>
                        <Text style={styles.textIcon}>Produk</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.presable} onPress={() => NavigatorService.navigate('Jasatukang')}>
