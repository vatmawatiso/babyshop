...
const Nilaiorder = (props) => {
  ...
  useEffect(() => {
    ...
    console.log("retail id = " + props.navigation.state.params.retail_id);
    console.log("retail name = " + props.navigation.state.params.retail_name);
    console.log("produk = " + props.navigation.state.params.prd_name);
    console.log("thumbnail = " + props.navigation.state.params.thumbnail);
    console.log("subtotal = " + props.navigation.state.params.subtotal);
    console.log("qtyall = " + props.navigation.state.params.qtyall);
